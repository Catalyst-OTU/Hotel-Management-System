        ...
        <table class="table table-bordered" id="table-data">
            ...
            ?>
                <tr>
                    ...
                    <td>Ghc<?php echo $res['PricePerRoom'] ?></td>
                    ...
                    <td>Ghc<?php echo $res['roomtotal'] ?></td>
	
					<td>Ghc<?php echo $res['mealtotal'] ?></td>
					<td>Ghc<?php echo $res['finaltotal'] ?></td>
                    <td class="action">
                        <a href="invoiceprint.php?id= <?php echo $res['id']?>"><button class="btn btn-primary"><i class="fa-solid fa-print"></i>Print</button></a>
						<a href="paymantdelete.php?id=<?php echo $res['id']?>" onclick="if (!confirm('Are you sure you want to delete <?php echo $res['Name'] ?>')) return false"><button class="btn btn-danger">Delete</button></a>
                    </td>
                </tr>
            <?php
            }
