...
<br>
    ...
    <div class="searchsection">
        ...
        <form action="./exportdata.php" method="post">
            <button class="exportexcel" id="exportexcel" name="exportstaffexcel" type="submit"><i class="fa-solid fa-file-arrow-down"></i></button>
        </form>
    </div>
            ...
            ?>
                <tr>
                    ...
                    <td class="action">
                        ...
                        <a href="deletestaff.php?id=<?php echo $res['id'] ?>" onclick="if (!confirm('Are you sure you want to delete <?php echo $res['name'] ?>')) return false"><button class='btn btn-danger'>Delete</button></a>
                    </td>
                </tr>
            <?php
            }
