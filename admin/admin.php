...
<body>
    ...
    <nav class="uppernav">
        ...
        <div class="logout">
        <a href="../logout.php" onclick="if (!confirm('Are you sure you want to logout')) return false"><button class="btn btn-primary">Logout</button></a>
        </div>
    </nav>
    <nav class="sidenav">
        <ul>
            ...
            <li class="pagebtn"><img src="../image/icon/staff.png">&nbsp&nbsp&nbsp Staffs</li>
            <li class="pagebtn"><img src="../image/icon/staff.png">&nbsp&nbsp&nbsp Guests</li>
        </ul>
    </nav>
    ...
    <div class="mainscreen">
        ...
        <iframe class="frames frame4" src="./rooms.php" frameborder="0"></iframe>
        <iframe class="frames frame5" src="./staffs.php" frameborder="0"></iframe>
        <iframe class="frames frame6" src="./users.php" frameborder="0"></iframe>
    </div>
</body>
