        ...
        <div class="auth_container">
            ...
            <div id="Log_in">
                ...
                if (isset($_POST['user_login_submit'])) {
                    ...
                    $sql = "SELECT * FROM guest WHERE Email = '$Email' AND Password = BINARY'$Password'";
                ...
                <form class="user_login authsection active" id="userlogin" action="" method="POST">
                    ...
                    <div class="footer_line">
                        ...
                        <h6>Go back home <a href="index.php">Homepage</a></h6>
                    </div>
                </form>
            ...
            <div id="sign_up">
                ...
                <form class="user_signup" id="usersignup" action="userbackend.php" method="POST">
                    <div class="form-floating">
                        <input type="text" class="form-control" name="Username" placeholder=" ">
                        <label for="Username">Username</label>
                    </div>
                    ...
                    <button type="submit" name="user_signup" class="auth_btn">Sign up</button>
